...
```python filename="main.py" line_numbers="true" line_number_start="9" line_highlights="15-24"
...
```python filename="main.py" line_numbers="true" line_number_start="27" line_highlights="36"
def setup():
    size(991, 768)
    image(
