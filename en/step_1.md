...
Create a global variable called 'map' and set it to load the 'old-map.jpg' image.

Replace `pass` in the `setup()` function with the canvas size and image data.

```python filename="main.py" line_numbers="true" line_number_start="9" line_highlights="11,12,16-23"
